...
export const componentsBCatalog: CatalogSlice = {
  en: {
    ...
    'compb.join.errNotFound': 'This invite was not found.',
    'compb.join.errRevoked': 'This invite has been revoked.',
    'compb.join.errUsed': 'This invite has already been used.',
    'compb.join.errExpired': 'This invite has expired.',
    'compb.join.errUnsigned': 'Sign in to accept an invite.',
    'compb.join.errSeatLimit': 'This company has no seats left. Ask an admin to upgrade the plan.',
    'compb.join.errPermission': 'You do not have permission to join with this invite.',
    ...
    'compb.pnl.periodCosts': 'Period costs',
    'compb.pnl.license': 'License',
    'compb.pnl.margin': 'Margin',
    'compb.pnl.availableFunding': 'Available funding',
    'compb.pnl.owedToFreelancers': 'Owed to freelancers',
    'compb.pnl.netAvailableFunding': 'Net available',
  ...
  fr: {
    ...
    'compb.join.errNotFound': 'Cette invitation est introuvable.',
    'compb.join.errRevoked': 'Cette invitation a été révoquée.',
    'compb.join.errUsed': 'Cette invitation a déjà été utilisée.',
    'compb.join.errExpired': 'Cette invitation a expiré.',
    'compb.join.errUnsigned': 'Connectez-vous pour accepter une invitation.',
    'compb.join.errSeatLimit': 'Cette entreprise n’a plus de sièges. Demandez à un admin d’augmenter le forfait.',
    'compb.join.errPermission': 'Vous n’avez pas l’autorisation de rejoindre avec cette invitation.',
    ...
    'compb.pnl.periodCosts': 'Coûts de la période',
    'compb.pnl.license': 'Licence',
    'compb.pnl.margin': 'Marge',
    'compb.pnl.availableFunding': 'Financement disponible',
    'compb.pnl.owedToFreelancers': 'Dû aux freelances',
    'compb.pnl.netAvailableFunding': 'Disponible net',
