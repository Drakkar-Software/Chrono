...
export const landingCatalog: CatalogSlice = {
  en: {
    ...
    'auth.reset.subtitle': 'Enter your email to get a reset code',
    'auth.reset.submit': 'Send code',
    'auth.reset.enterCodeTitle': 'Enter your code',
    'auth.reset.enterCodeSubtitle': 'We emailed you a 6-digit code. Enter it to continue.',
    'auth.reset.codeLabel': 'Reset code',
    'auth.reset.codePlaceholder': '123456',
    'auth.reset.verify': 'Verify',
    ...
    'auth.errors.email_not_confirmed': 'Please confirm your email first.',
    'auth.errors.user_already_exists': 'An account with this email already exists.',
    'auth.errors.email_exists': 'An account with this email already exists.',
    'auth.errors.weak_password': 'Please choose a stronger password.',
    'auth.errors.over_email_send_rate_limit': 'Too many emails sent. Please wait a moment and try again.',
    'auth.errors.over_request_rate_limit': 'Too many attempts. Please wait a moment and try again.',
    'auth.errors.validation_failed': 'Please check the information you entered.',
    'auth.errors.user_not_found': 'No account found for this email.',
    'auth.errors.same_password': 'The new password must be different from the old one.',
    'auth.errors.signup_disabled': 'Sign-ups are currently disabled.',
    ...
    'onboarding.role.subtitleJoin':
      'Step 1 of 1 · Enter your name and the invite link or code your team shared.',
    ...
    'onboarding.role.optJoin': 'Join with an invite',
    'onboarding.role.nameLabel': 'Your name',
    'onboarding.role.namePlaceholder': 'Jane Doe',
    'onboarding.role.codeLabel': 'Invite code or link',
    'onboarding.role.codePlaceholder': 'Paste your invite link or code',
    ...
    'onboarding.role.errCompanyCode': 'Enter your invite code or link',
    'onboarding.role.errJoin': "Couldn't join — the invite may be invalid, used or expired.",
  ...
  fr: {
    ...
    'auth.reset.subtitle': 'Saisissez votre e-mail pour recevoir un code de réinitialisation',
    'auth.reset.submit': 'Envoyer le code',
    'auth.reset.enterCodeTitle': 'Saisissez votre code',
    'auth.reset.enterCodeSubtitle': 'Nous vous avons envoyé un code à 6 chiffres par e-mail. Saisissez-le pour continuer.',
    'auth.reset.codeLabel': 'Code de réinitialisation',
    'auth.reset.codePlaceholder': '123456',
    'auth.reset.verify': 'Vérifier',
    ...
    'auth.errors.invalid_credentials': 'E-mail ou mot de passe incorrect.',
    'auth.errors.email_not_confirmed': 'Veuillez d’abord confirmer votre e-mail.',
    'auth.errors.user_already_exists': 'Un compte existe déjà avec cet e-mail.',
    'auth.errors.email_exists': 'Un compte existe déjà avec cet e-mail.',
    'auth.errors.weak_password': 'Veuillez choisir un mot de passe plus robuste.',
    'auth.errors.over_email_send_rate_limit': 'Trop d’e-mails envoyés. Veuillez patienter puis réessayer.',
    'auth.errors.over_request_rate_limit': 'Trop de tentatives. Veuillez patienter puis réessayer.',
    'auth.errors.validation_failed': 'Veuillez vérifier les informations saisies.',
    'auth.errors.user_not_found': 'Aucun compte trouvé pour cet e-mail.',
    'auth.errors.same_password': 'Le nouveau mot de passe doit être différent de l’ancien.',
    'auth.errors.signup_disabled': 'Les inscriptions sont actuellement désactivées.',
    ...
    'onboarding.role.subtitleJoin':
      'Étape 1 sur 1 · Saisissez votre nom et le lien ou code d’invitation partagé par votre équipe.',
    'onboarding.role.subtitleCreate':
    ...
    'onboarding.role.optJoin': 'Rejoindre avec une invitation',
    'onboarding.role.nameLabel': 'Votre nom',
    'onboarding.role.namePlaceholder': 'Jean Dupont',
    'onboarding.role.codeLabel': 'Code ou lien d’invitation',
    'onboarding.role.codePlaceholder': 'Collez votre lien ou code d’invitation',
    ...
    'onboarding.role.errCompanyCode': 'Saisissez votre code ou lien d’invitation',
    'onboarding.role.errJoin': 'Impossible de rejoindre — l’invitation est peut-être invalide, déjà utilisée ou expirée.',
